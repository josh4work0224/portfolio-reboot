...
import { GalleryColsProps } from "../types/project"; // 直接導入 GalleryImage 類型

const GalleryCols: React.FC<GalleryColsProps> = ({
  image1,
  image2,
  backgroundColor = "#ffffff",
  className = "",
}) => {
  if (!image1?.asset?.url || !image2?.asset?.url) return null;
