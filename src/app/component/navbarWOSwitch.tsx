...
const NavbarWOSwitch = () => {
  ...
  return (
    <nav
      className={`fixed z-50 lg:h-screen lg:w-auto w-full ${isMobileMenuOpen ? "mix-blend-normal" : "mix-blend-difference"} ${
                ...
                {isMobileMenuOpen && (
                  <>
                    ...
                    <div
                      ...
                      }  fixed left-0 top-0 h-full w-[20rem] z-50 shadow-2xl flex flex-col justify-between px-24 py-8 popup-menu-slide-in`}
                      style={{ pointerEvents: "auto" }}
                    >
                      <Link href="/">
                        <strong>SHENG-CHI</strong> H.
